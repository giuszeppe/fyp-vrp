...
class RLModel:
    def __init__(
        ...
        if self.env is None:
            # Still synthetic RL4CO CVRPTW data.
            # This is NOT Solomon training data, but at least keep it explicit.
    ...
    def solve(
        ...
        return Solution(strategy="rl4co", routes=routes, total_distance=cost)
